...
<head>
    ...
    <title>Culture Bénin | Associations Région-Langue</title>
    ...
    <div class="header-content">
        <div class="header-left">
            ...
            <h1 class="header-title">
                <i class="bi bi-link-45deg me-2"></i>Associations Région-Langue
            </h1>
        </div>
...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-content">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="<?php echo e(route('parler.index')); ?>" class="nav-link active">
                    <i class="nav-icon bi bi-link-45deg"></i>
                    <span>Relations</span>
                    <span class="nav-badge badge bg-indigo"><?php echo e($parlers->count()); ?></span>
                </a>
            </div>
        </nav>
    </div>
...
<main class="main-content" id="mainContent">
    ...
    <div class="page-title-section">
        <div>
            <h1>Associations Région-Langue</h1>
            <p>Gérez les langues parlées dans chaque région</p>
        </div>
        <a href="<?php echo e(route('parler.create')); ?>" class="btn btn-primary">
            <i class="bi bi-plus-circle me-2"></i>Nouvelle association
        </a>
    </div>
    ...
    <div class="main-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark"><?php echo e($parlers->count()); ?> association(s)</span>
            </div>
        </div>

        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover align-middle" id="parlerTable">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr id="parler-<?php echo e($parler->id_region); ?>-<?php echo e($parler->id_langue); ?>">
                            <td class="ps-4 fw-semibold text-muted">
                                #<?php echo e($parler->id_region); ?>-<?php echo e($parler->id_langue); ?>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="parler-region fw-medium"><?php echo e($parler->region->nom_region ?? 'N/A'); ?></span>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="parler-langue fw-medium"><?php echo e($parler->langue->nom_langue ?? 'N/A'); ?></span>
                                </div>
                            </td>
                            
                            <td>
                                <span class="badge bg-primary parler-code px-2 py-1">
                                    <?php echo e($parler->langue->code_langue ?? 'N/A'); ?>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-sm" role="group">
                                    ...
                                    <button class="btn btn-outline-warning border-0 btn-hover-scale" 
                                            onclick="editRow(<?php echo e($parler->id_region); ?>, <?php echo e($parler->id_langue); ?>)" 
                                    ...
                                    <!-- Bouton Voir -->
                                    <a href="<?php echo e(route('parler.show', ['id_region' => $parler->id_region, 'id_langue' => $parler->id_langue])); ?>" 
                                    ...
                                    <!-- Bouton Supprimer -->
                                    <form action="<?php echo e(route('parler.destroy', ['id_region' => $parler->id_region, 'id_langue' => $parler->id_langue])); ?>" method="POST" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="submit" 
                                                class="btn btn-outline-danger border-0 btn-hover-scale" 
                                                onclick="return confirm('Supprimer l\\'association « <?php echo e($parler->region->nom_region ?? 'N/A'); ?> - <?php echo e($parler->langue->nom_langue ?? 'N/A'); ?> » ?')" 
                        ...
                        <?php if($parlers->isEmpty()): ?>
                        <tr>
                            <td colspan="5" class="text-center py-5">
                                <div class="empty-state">
                                    <i class="bi bi-inbox"></i>
                                    <p class="mb-3">Aucune association trouvée</p>
                                    <a href="<?php echo e(route('parler.create')); ?>" class="btn btn-primary">
        ...
        <!-- Pied de table -->
        <?php if($parlers->isNotEmpty()): ?>
        <div class="card-footer">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="mb-0 text-muted small">
                        Affichage de <strong><?php echo e($parlers->count()); ?></strong> association(s)
                    </p>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\CultureBenin\resources\views/parler/index.blade.php ENDPATH**/ ?>