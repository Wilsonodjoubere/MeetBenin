...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-content">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="<?php echo e(route('commentaires.index')); ?>" class="nav-link active">
                    <i class="nav-icon bi bi-chat-text"></i>
                    <span>Commentaires</span>
                    <span class="nav-badge badge bg-pink"><?php echo e($commentaires->count()); ?></span>
                </a>
            </div>
...
<main class="main-content" id="mainContent">
    ...
    <div class="page-title-section">
        ...
        <a href="<?php echo e(route('commentaires.create')); ?>" class="btn btn-primary">
    ...
    <div class="main-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark"><?php echo e($commentaires->count()); ?> commentaire(s)</span>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle" id="commentairesTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="ps-4 fw-semibold text-muted">#<?php echo e($commentaire->id_commentaire); ?></td>
                            
                            <td>
                                <div class="d-flex align-items-center">
                                    <i class="bi bi-person-circle me-2 text-primary"></i>
                                    <span class="fw-medium"><?php echo e($commentaire->utilisateur->name ?? 'N/A'); ?></span>
                                </div>
                            </td>
                            
                            <td>
                                <span class="text-muted small"><?php echo e(Str::limit($commentaire->contenu->titre ?? 'N/A', 30)); ?></span>
                            </td>
                            
                            <td>
                                <span class="text-muted small"><?php echo e(Str::limit($commentaire->texte, 50)); ?></span>
                            </td>
                            
                            <td class="text-center">
                                <?php if($commentaire->note): ?>
                                <span class="badge badge-warning">
                                    <?php echo e($commentaire->note); ?>/5
                                </span>
                                <?php else: ?>
                            ...
                            <td class="text-center">
                                <span class="text-muted small"><?php echo e($commentaire->date->format('d/m/Y H:i')); ?></span>
                            </td>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-sm" role="group">
                                    ...
                                    <a href="<?php echo e(route('commentaires.edit', $commentaire->id_commentaire)); ?>" 
                                    ...
                                    <form action="<?php echo e(route('commentaires.destroy', $commentaire->id_commentaire)); ?>" method="POST" class="d-inline">
                                        <?php echo csrf_field(); ?>
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="mb-0 text-muted small">
                        Affichage de <strong><?php echo e($commentaires->count()); ?></strong> commentaire(s)
                    </p>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\CultureBenin\resources\views/commentaires/index.blade.php ENDPATH**/ ?>