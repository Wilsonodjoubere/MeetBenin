...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-content">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="<?php echo e(route('utilisateurs.index')); ?>" class="nav-link active">
                    <i class="nav-icon bi bi-people-fill"></i>
                    <span>Utilisateurs</span>
                    <span class="nav-badge badge bg-primary"><?php echo e($utilisateurs->count()); ?></span>
                </a>
            </div>

            <div class="nav-item">
                <a href="<?php echo e(route('langues.index')); ?>" class="nav-link">
            ...
            <div class="nav-item">
                <a href="<?php echo e(route('contenus.index')); ?>" class="nav-link">
            ...
            <div class="nav-item">
                <a href="<?php echo e(route('media.index')); ?>" class="nav-link">
            ...
            <div class="nav-item">
                <a href="<?php echo e(route('commentaires.index')); ?>" class="nav-link">
            ...
            <div class="nav-item">
                <a href="<?php echo e(route('type-contenus.index')); ?>" class="nav-link">
            ...
            <div class="nav-item">
                <a href="<?php echo e(route('types_media.index')); ?>" class="nav-link">
            ...
            <div class="nav-item">
                <a href="<?php echo e(route('parler.index')); ?>" class="nav-link">
    ...
    <div class="main-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark"><?php echo e($utilisateurs->count()); ?> utilisateur(s)</span>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="ps-4 fw-semibold text-muted mobile-hidden">
                                #<?php echo e($utilisateur->id_utilisateur); ?>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <?php if($utilisateur->photo): ?>
                                        <img src="<?php echo e(asset('storage/photos/' . $utilisateur->photo)); ?>" 
                                             alt="<?php echo e($utilisateur->prenom); ?> <?php echo e($utilisateur->nom); ?>" 
                                    ...
                                    <?php endif; ?>
                                    <div>
                                        <div class="fw-medium"><?php echo e($utilisateur->prenom); ?> <?php echo e($utilisateur->nom); ?></div>
                                        <small class="text-muted d-block mobile-hidden">
                                            <?php echo e($utilisateur->sexe === 'M' ? 'Homme' : ($utilisateur->sexe === 'F' ? 'Femme' : 'Non spécifié')); ?>

                                            <?php if($utilisateur->date_naissance): ?>
                                                • <?php echo e(\Carbon\Carbon::parse($utilisateur->date_naissance)->age); ?> ans
                                            <?php endif; ?>
                                        </small>
                            ...
                            <td class="mobile-hidden">
                                <span class="text-muted"><?php echo e($utilisateur->email); ?></span>
                            </td>
                            ...
                            <td class="mobile-hidden">
                                <span class="badge bg-light text-dark">
                                    <?php echo e($utilisateur->langue ? $utilisateur->langue->nom_langue : 'Non spécifiée'); ?>
                            ...
                            <td>
                                ...
                                ?>
                                <span class="badge bg-<?php echo e($statusColors[$utilisateur->statut] ?? 'secondary'); ?>">
                                    <?php echo e(ucfirst($utilisateur->statut)); ?>
                            ...
                            <td class="text-center">
                                <div class="action-buttons">
                                    <!-- Bouton Voir -->
                                    <a href="<?php echo e(route('utilisateurs.show', $utilisateur->id_utilisateur)); ?>" 
                                    ...
                                    <!-- Bouton Éditer -->
                                    <a href="<?php echo e(route('utilisateurs.edit', $utilisateur->id_utilisateur)); ?>" 
                                    ...
                                    <form action="<?php echo e(route('utilisateurs.destroy', $utilisateur->id_utilisateur)); ?>" method="POST" class="d-inline">
                                        ...
                                        <button type="submit" 
                                                ...
                                                onclick="return confirm('Supprimer l\\'utilisateur « <?php echo e($utilisateur->prenom); ?> <?php echo e($utilisateur->nom); ?> » ?')" 
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="mb-0 text-muted small">
                        Affichage de <strong><?php echo e($utilisateurs->count()); ?></strong> utilisateur(s)
                    </p>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\CultureBenin\resources\views/utilisateurs/index.blade.php ENDPATH**/ ?>