...
<main class="main-content">
    ...
    <div class="quick-actions">
        ...
        <div class="actions-grid">
            <a href="<?php echo e(route('utilisateurs.create')); ?>" target="_blank" class="action-btn">
                <i class="bi bi-person-plus action-icon"></i>
                <span class="action-text">Nouvel Utilisateur</span>
            </a>
            <a href="<?php echo e(route('contenus.create')); ?>" target="_blank" class="action-btn">
                <i class="bi bi-file-plus action-icon"></i>
                <span class="action-text">Nouveau Contenu</span>
            </a>
            <a href="<?php echo e(route('media.create')); ?>" target="_blank" class="action-btn">
                <i class="bi bi-cloud-upload action-icon"></i>
                <span class="action-text">Uploader Média</span>
            </a>
            <a href="<?php echo e(route('langues.create')); ?>" target="_blank" class="action-btn">
...
</html><?php /**PATH C:\xampp\htdocs\CultureBenin\resources\views/dashboard.blade.php ENDPATH**/ ?>