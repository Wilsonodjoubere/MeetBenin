...
<head>
    ...
    <title>Culture Bénin | Gestion des Régions</title>
    ...
    <div class="header-content">
        <div class="header-left">
            ...
            <h1 class="header-title">
                <i class="bi bi-geo-alt-fill me-2"></i>Gestion des Régions
            </h1>
        </div>
...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-content">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="<?php echo e(route('regions.index')); ?>" class="nav-link active">
                    <i class="nav-icon bi bi-geo-alt-fill"></i>
                    <span>Régions</span>
                    <span class="nav-badge badge bg-success"><?php echo e($regions->count()); ?></span>
                </a>
            </div>
...
<main class="main-content" id="mainContent">
    ...
    <div class="page-title-section">
        <div>
            ...
            <p>Administrez les régions du Bénin</p>
        </div>
    ...
    <div class="main-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark"><?php echo e($regions->count()); ?> région(s)</span>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="fw-medium"><?php echo e($region->nom_region); ?></span>
                                </div>
                            </td>
                            
                            <td>
                                <span class="text-muted small">
                                    <?php echo e(Str::limit($region->description, 60) ?: '—'); ?>
                            ...
                            <td>
                                <span class="fw-semibold">
                                    <?php echo e($region->population ? number_format($region->population, 0, ',', ' ') : '—'); ?>
                            ...
                            <td>
                                <span>
                                    <?php echo e($region->superficie ? number_format($region->superficie, 0, ',', ' ') . ' km²' : '—'); ?>
                            ...
                            <td>
                                <?php if($region->localisation): ?>
                                    <span class="badge bg-info px-2 py-1">
                                        <?php echo e($region->localisation); ?>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-sm" role="group">
                                    ...
                                    <!-- Bouton Voir -->
                                    <a href="<?php echo e(route('regions.show', $region->id_region)); ?>" 
                                    ...
                                    <!-- Bouton Supprimer -->
                                    <form action="<?php echo e(route('regions.destroy', $region->id_region)); ?>" method="POST" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="submit" 
                                                class="btn btn-outline-danger border-0 btn-hover-scale" 
                                                onclick="return confirm('Supprimer la région « <?php echo e($region->nom_region); ?> » ?')" 
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-5">
                                <div class="empty-state">
                                    ...
                                    <p class="mb-3">Aucune région trouvée</p>
                                    <a href="<?php echo e(route('regions.create')); ?>" class="btn btn-primary">
        ...
        <!-- Pied de table -->
        <?php if($regions->isNotEmpty()): ?>
        <div class="card-footer">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="mb-0 text-muted small">
                        Affichage de <strong><?php echo e($regions->count()); ?></strong> région(s)
                    </p>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\CultureBenin\resources\views/regions/index.blade.php ENDPATH**/ ?>