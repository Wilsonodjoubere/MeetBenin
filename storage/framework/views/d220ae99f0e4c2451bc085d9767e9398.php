    ...
    <div class="login-container">
        <div class="login-left">
            <div class="image-content">
                <img src="<?php echo e(asset('images/biguerra.jpg')); ?>" alt="Culture Bénin" class="cultural-image">
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-session-status','data' => ['class' => 'status-message status-success','status' => session('status')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'status-message status-success','status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(session('status'))]); ?>
...
<?php endif; ?>
            ...
            <div class="auth-links">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" class="auth-link">
...
</html><?php /**PATH C:\xampp\htdocs\CultureBenin\resources\views/auth/login.blade.php ENDPATH**/ ?>