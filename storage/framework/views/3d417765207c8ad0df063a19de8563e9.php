...
<head>
    ...
    <title>Culture Bénin | Types de Contenu</title>
    ...
    <div class="header-content">
        <div class="header-left">
            ...
            <h1 class="header-title">
                <i class="bi bi-file-earmark-richtext me-2"></i>Types de Contenu
            </h1>
        </div>
...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-content">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="<?php echo e(route('type-contenus.index')); ?>" class="nav-link active">
                    <i class="nav-icon bi bi-tags"></i>
                    <span>Types Contenu</span>
                    <span class="nav-badge badge bg-secondary"><?php echo e($typeContenus->count()); ?></span>
                </a>
            </div>
...
<main class="main-content" id="mainContent">
    ...
    <div class="page-title-section">
        <div>
            ...
            <p>Administrez les types de contenu disponibles dans le système</p>
        </div>
        <a href="<?php echo e(route('type-contenus.create')); ?>" class="btn btn-primary">
    ...
    <div class="main-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark"><?php echo e($typeContenus->count()); ?> type(s)</span>
            </div>
        </div>

        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-hover align-middle" id="typeContenusTable">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $typeContenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $typeContenu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr id="typeContenu-<?php echo e($typeContenu->id_type_contenu); ?>">
                            <td class="ps-4 fw-semibold text-muted">
                                #<?php echo e($typeContenu->id_type_contenu); ?>

                            </td>
                            
                            <td class="editable" onclick="editCell(this, 'nom_type_contenu', <?php echo e($typeContenu->id_type_contenu); ?>)">
                                <div class="d-flex align-items-center">
                                    <i class="bi bi-file-earmark-richtext me-2 text-primary"></i>
                                    <span class="typeContenu-nom_type_contenu fw-medium"><?php echo e($typeContenu->nom_type_contenu); ?></span>
                                </div>
                            </td>
                            
                            <td class="editable" onclick="editCell(this, 'description', <?php echo e($typeContenu->id_type_contenu); ?>)">
                                <span class="typeContenu-description text-muted small">
                                    <?php echo e($typeContenu->description ?: '—'); ?>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-sm" role="group">
                                    ...
                                    <button class="btn btn-outline-warning border-0 btn-hover-scale" 
                                            onclick="editRow(<?php echo e($typeContenu->id_type_contenu); ?>)" 
                                    ...
                                    <!-- Bouton Voir -->
                                    <a href="<?php echo e(route('type-contenus.show', $typeContenu->id_type_contenu)); ?>" 
                                    ...
                                    <!-- Bouton Supprimer -->
                                    <form action="<?php echo e(route('type-contenus.destroy', $typeContenu->id_type_contenu)); ?>" method="POST" class="d-inline">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="submit" 
                                                class="btn btn-outline-danger border-0 btn-hover-scale" 
                                                onclick="return confirm('Supprimer le type « <?php echo e($typeContenu->nom_type_contenu); ?> » ?')" 
                        ...
                        <?php if($typeContenus->isEmpty()): ?>
                        <tr>
                            <td colspan="4" class="text-center py-5">
                                <div class="empty-state">
                                    <i class="bi bi-inbox"></i>
                                    <p class="mb-3">Aucun type de contenu trouvé</p>
                                    <a href="<?php echo e(route('type-contenus.create')); ?>" class="btn btn-primary">
        ...
        <!-- Pied de table -->
        <?php if($typeContenus->isNotEmpty()): ?>
        <div class="card-footer">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="mb-0 text-muted small">
                        Affichage de <strong><?php echo e($typeContenus->count()); ?></strong> type(s) de contenu
                    </p>
                </div>
...
</html><?php /**PATH C:\xampp\htdocs\CultureBenin\resources\views/types_contenus/index.blade.php ENDPATH**/ ?>