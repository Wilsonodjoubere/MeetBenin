        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="{{ route('regions.index') }}" class="nav-link active">
                    ...
                    <span>Régions</span>
                    <span class="nav-badge badge bg-success">{{ $regions->count() }}</span>
                </a>
            </div>
    ...
    <div class="main-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark">{{ $regions->count() }} région(s)</span>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="fw-medium">{{ $region->nom_region }}</span>
                                </div>
                            </td>
