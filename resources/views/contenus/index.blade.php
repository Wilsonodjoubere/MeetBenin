...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-content">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="{{ route('contenus.index') }}" class="nav-link active">
                    <i class="nav-icon bi bi-file-earmark-text"></i>
                    <span>Contenus</span>
                    <span class="nav-badge badge bg-warning">{{ $contenus->count() }}</span>
                </a>
            </div>
    ...
    <div class="main-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark">{{ $contenus->count() }} contenu(s)</span>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr id="contenu-{{ $contenu->id_contenu }}">
                            ...
                            <td>
                                ...
                                @endphp
                                <span class="badge {{ $statusColors[$contenu->statut] ?? 'bg-secondary' }}">
