...
<div class="container-fluid px-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h4 mb-1 text-gray-800">Langues</h1>
            <p class="text-muted mb-0">Administrez les langues disponibles dans le système</p>
        </div>
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white py-3 border-bottom">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark fs-6">{{ $langues->count() }} langue(s)</span>
            </div>
        </div>

        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0" id="languesTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="5" class="text-center py-5 text-muted">
                                ...
                                <br>
                                <a href="{{ route('langues.create') }}" class="btn btn-primary btn-sm mt-2">
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body py-3">
                <p class="mb-0 small">Êtes-vous sûr de vouloir supprimer cette langue ?</p>
            </div>
