...
<aside class="sidebar" id="sidebar">
    <div class="sidebar-content">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="{{ route('langues.index') }}" class="nav-link active">
                    <i class="nav-icon bi bi-translate"></i>
                    <span>Langues</span>
                    <span class="nav-badge badge bg-info">{{ $langues->count() }}</span>
                </a>
            </div>
    ...
    <div class="main-card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-light text-dark">{{ $langues->count() }} langue(s)</span>
            </div>
        </div>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle" id="languesTable">
                    ...
                    <tbody>
                        ...
                        <tr id="langue-{{ $langue->id_langue }}">
                            <td class="ps-4 fw-semibold text-muted">
                                #{{ $langue->id_langue }}
                            </td>
                            
                            <td class="editable" onclick="editCell(this, 'nom_langue', {{ $langue->id_langue }})">
                                <div class="d-flex align-items-center">
                                    <i class="bi bi-translate me-2 text-primary"></i>
                                    <span class="langue-nom_langue fw-medium">{{ $langue->nom_langue }}</span>
                                </div>
                            </td>
                            
                            <td class="editable" onclick="editCell(this, 'code_langue', {{ $langue->id_langue }})">
                                <span class="badge bg-primary langue-code_langue px-2 py-1">
                                    {{ $langue->code_langue }}
                                </span>
                            </td>
                            
                            <td class="editable" onclick="editCell(this, 'description', {{ $langue->id_langue }})">
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-sm" role="group">
                                    ...
                                    <button class="btn btn-outline-warning border-0 btn-hover-scale" 
                                            onclick="editRow({{ $langue->id_langue }})" 
                                    ...
                                    <form action="{{ route('langues.destroy', $langue->id_langue) }}" method="POST" class="d-inline">
                                        ...
                                        <button type="submit" 
                                                ...
                                                onclick="return confirm('Supprimer la langue « {{ $langue->nom_langue }} » ?')" 
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="mb-0 text-muted small">
                        Affichage de <strong>{{ $langues->count() }}</strong> langue(s)
                    </p>
                </div>
